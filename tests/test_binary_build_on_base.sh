...
docker run -d \
    ...
    -e BUNDLE_URL=https://nguyenminhtienitvn-meteord-tests.s3-us-west-2.amazonaws.com/meteord-test-bundle.tar.gz \
    -e REBUILD_NPM_MODULES=1 \
    -p 9090:80 \
    "nguyenminhtienitvn/meteord:node-${NODE_VERSION}-base"
...
if [[ $appContent != *"nguyenminhtienitvn/meteord:bin-build"* ]]; then
